...
class ControllerAndPropertiesTest {
    ...
    void testSaveCustomer() throws Exception {
        ...
        CustomerResponse expectedResponse = new CustomerResponse(sampleCustomerForCustomerControllerTest.getId(), sampleCustomerForCustomerControllerTest.getFirstName(), sampleCustomerForCustomerControllerTest.getLastName(), sampleCustomerForCustomerControllerTest.getEmail(), sampleCustomerForCustomerControllerTest.getSalary());
